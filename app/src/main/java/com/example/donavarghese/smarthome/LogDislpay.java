...
public class LogDislpay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_log_dislpay);
        ...
        for(int i = 0; i < TextBox.size() ; i++){
            ...
            ListItem listItem = new ListItem(TextBox.get(i) , "Garage Open");
            listItems.add(listItem); //add the item to the ArrayList!
        }

        for(int i = 0; i < TextBox1.size() ; i++){

            ListItem listItem1 = new ListItem(TextBox1.get(i) , "Garage Close");
